...
<div id="preloader">
                    ...
                    <div class="col-sm-12">
                        <div class="hero-wrapper v-center">
                            ...
                            <div class="hero-subtitle light" data-animation-direction="fade"
                                data-animation-delay="1000">14 Tháng 7 2024</div>
                        ...
                        <div class="image">
                            ...
                            <div class="hover-info neela-style">
                                <div class="content">
                                    ...
                                    <p>
                                        Là một người hay cười nhưng lại sống nội tâm, thích đi du lịch và làm đồ
                                        handmade , trồng cây và yêu...
                                        <a class="button-see"
                                            data-src="./assets/images/66695e13a727b040b10f5440/BI_08082.jpg"
                                            data-content="Là một người hay cười nhưng lại sống nội tâm, thích đi du lịch và làm đồ handmade , trồng cây và yêu thiên nhiên. Ngoài ra còn rất thích vẽ vời, nuôi mèo và nuôi ước mơ có cho mình một vườn hồng khoe sắc."
                                            data-instagram="" data-twitter=""
                                    ...
                                    <ul class="sn-icons">
                                        <li>
                                            <a
                                                href="https://www.facebook.com/profile.php?id=100009819938233">
                        ...
                        <div class="invite neela-style" data-animation-direction="from-left" data-animation-delay="100">
                            ...
                            <div class="invite_info px-2 px-lg-4">
                                ...
                                <div class="center m-0">
                                    <form action="{{ route('confirm', ['code' => request()->code]) }}" id="confirmForm" class="d-none">
                                        @csrf()
                                    </form>
                                    <a
                                    id="confirmBtn"
                                    ...
                                    <div class="d-flex align-items-center event-item-content">
                                        ...
                                        <div class="d-inline-block">
                                            ...
                                            <p class="w-100 mb-2 mt-2">
                                                ...
                                                <strong>11:00 14/07/2024</strong>
                                            </p>
                                            <p class="w-100 mb-0 mt-1">
                                                <i class="fa fa-map-marker" aria-hidden="true"></i>
                                                <strong>Số 99 - Đường Nguyễn Thị Minh Khai - Xã Hội Hợp - Thành Phố Vĩnh
                                    ...
                                    <div class="info">
                                        <div class="calendar-button"
                                            ...
                                            <div class="atcb" style="display:none;">
                                                ...
                                                "startTime":"11:00",
                                                "endTime":"11:00",
                                                "location":"Số 99 - Đường Nguyễn Thị Minh Khai - Xã Hội Hợp - Thành Phố
                                ...
                                <div class="neela-style">
                                    <div class="d-flex align-items-center event-item-content">
                                        ...
                                        <div class="d-inline-block">
                                            ...
                                            <p class="w-100 mb-0 mt-1"><i class="fa fa-map-marker"
                                                    aria-hidden="true"></i> <strong>Thôn Đô Lương – Xã An Hòa – Huyện
                                                    Tam Dương – Tỉnh Vĩnh Phúc</strong></p>
                                        </div>
                                    </div>
                                    <div class="info">
                                        <div class="calendar-button"
                                        ...
                                        <div class="vitualTextarea">
                                            ...
                                            <div class="textAreaIcons">
                                                ...
                                                <span class="hide-autocomplete tooltip-custom" style="display: none;">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                        fill="currentColor" class="bi bi-lightbulb-off"
                                                        viewBox="0 0 16 16">
                                                ...
                                                <div class="wishes-autocomplete-content" style="display: none;">
                                                    <input type="text" id="searchWishSuggestions"
                                                        onkeyup="searchWishSuggestionsFunction()"
    ...
    <div id="menu-access" class="">
        ...
        <ul class="p-0 m-0 list-menu-icon">
            ...
            <li class="text-center">
                <a href="{{ route('showConfirmForm') }}" target="_blank" class="text-white">
                    <span class="content-button tooltipBtn">
    ...
    <script>
        var slidehow_images = ["./assets/images/66695e13a727b040b10f5440/templates/644000ba4f8e0c7ddf09c709/BI_08224.jpg", "./assets/images/66695e13a727b040b10f5440/templates/644000ba4f8e0c7ddf09c709/BI_08684.jpg", "./assets/images/66695e13a727b040b10f5440/templates/644000ba4f8e0c7ddf09c709/BI_080841.jpg",];
